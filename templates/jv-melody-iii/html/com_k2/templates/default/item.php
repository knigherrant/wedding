...
<div id="k2Container" class="itemViewdetail <?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	...
	<div class="itemMeta">
		<?php if($this->item->params->get('itemDateCreated')): ?>
			<!-- Date created -->
			<span class="created">
			<i class="fa fa-calendar-o" aria-hidden="true"></i> <?php echo JHTML::_('date', $this->item->created, JText::_('DATE_FORMAT_LC3')) ?>
			</span>
		<?php endif; ?>
    ...
    <?php endif; ?>
    <!-- Plugins: AfterDisplayContent jvlike -->
	...
	<?php endif; ?>
	  ...
	  <?php endif; ?>
		...
		<div class="itemContentFooter">
			...
			<?php if($this->item->params->get('itemDateModified') && intval($this->item->modified)!=0): ?>
			<!-- Item date modified -->
         <span class="ItemDateCreated itemDateModified">
  ...
  <div class="boxDescription">
  	...
  	<img class="left" src="<?php echo $this->item->author->avatar; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($this->item->author->name); ?>" />
  	<?php endif; ?>
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
		    ...
		    <div class="commentText"><?php echo $comment->commentText; ?></div>
				...
				<span class="commentToolbar">
					...
					<a class="report" rel="{handler:'iframe',size:{x:560,y:480}}" href="<?php echo JRoute::_('index.php?option=com_k2&view=comments&task=report&commentID='.$comment->id)?>"><?php echo JText::_('K2_REPORT')?></a>
					<?php endif; ?>
