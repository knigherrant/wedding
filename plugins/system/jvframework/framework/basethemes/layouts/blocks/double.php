<div class="block blockdouble  equal-column <?php echo $options['class']; ?> row">
<?php 
$count = count($html);
if($count)
	switch ($count) {	
		case 1:
			...
			break;	
		case 2:			
			printf('<div class="col-md-8 col-sm-8">%s</div>', $html[0]);
			printf('<div class="col-md-4 col-sm-4">%s</div>', $html[1]);
			break;	
		case 3:
			printf('<div class="col-md-6 col-sm-6">%s</div>', $html[0]);
