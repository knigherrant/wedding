...
$min_cachePath = dirname(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))).'/cache/min';
 ...
 * this accordingly.
 */
$min_libPath = dirname(dirname(dirname(__FILE__))) . '/libraries/classes/minify';
